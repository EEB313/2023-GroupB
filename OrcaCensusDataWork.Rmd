...
All proxy measures of lactating females (females with fecundity unavailabe, birth count, pregnancy count) are not normally distributed, so we will use GLMMs
