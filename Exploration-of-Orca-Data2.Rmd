...
chum_generator <- function(){
  for (year in years_measured){
    chum_density <- sample(x = seq(0.46,6.17,0.02), replace = T) #choosing a random value betwen the range of 0.46 to 6.17, Replacing is True
